neutral = [
    ...
    "I remember when 100 megabytes of storage would cost you the equivilant of £300",
    ...
    "Did I ever tell you that I once got an autograph from Edgar F. 'Ted' Codd. I keep it on my mantelpeice",
